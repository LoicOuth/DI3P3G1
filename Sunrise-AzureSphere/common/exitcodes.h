...
typedef enum {
    ...
    ExitCode_AdcTimerHandler_Poll = 32,
    ExitCode_Init_AdcOpen=33,
    ExitCode_Init_GetBitCount=34,
    ExitCode_Init_UnexpectedBitCount=35,
    ExitCode_Init_SetRefVoltage=36,
    ExitCode_Init_OpenGpio=37,
    ExitCode_Init_ChauffeEauTimer = 38,
